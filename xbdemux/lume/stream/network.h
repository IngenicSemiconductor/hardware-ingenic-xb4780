...
int nop_streaming_seek( int fd, loff_t pos, streaming_ctrl_t *stream_ctrl );
void streaming_ctrl_free( streaming_ctrl_t *streaming_ctrl );

int http_send_request(URL_t *url, loff_t pos);
...
int http_seek(stream_t *stream, loff_t pos);
