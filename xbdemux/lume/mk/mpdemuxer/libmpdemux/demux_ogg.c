        ...
        while (ogg_stream_packetout(oss, &op) == 1) {
            ...
            if (op.granulepos >= 0) {
                ...
                if (ogg_d->initial_granulepos == MP_NOPTS_VALUE && (flags & 1)) {
                    ...
                    if (ogg_d->index_mode != 2 && ogg_d->pos < demuxer->movi_end - 2 * 270000) {
            ...
            if (ogg_d->index_mode == 2 && (flags || (os->vorbis && op.granulepos >= 0))) {
