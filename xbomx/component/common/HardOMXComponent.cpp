...
HardOMXComponent::HardOMXComponent(
    ...
    *component = mComponent;
    ...
    ALOGE("HardOMXComponent::HardOMXComponent construction with name:%s", name);
}
...
OMX_ERRORTYPE HardOMXComponent::GetExtensionIndexWrapper(
        ...
        OMX_STRING name,
        OMX_INDEXTYPE *index) {
    ALOGE("HardOMXComponent::GetExtensionIndexWrapper name:%s", (char*)name);
    HardOMXComponent *me =
        (HardOMXComponent *)
	((OMX_COMPONENTTYPE *)component)->pComponentPrivate;
	...
	*index = (OMX_INDEXTYPE) OMX_IndexParamSetShContext;
    }else{
	ALOGE("HardOMXComponent::GetExtensionIndexWrapper go soft");
