...
struct HWColorConverter : public RefBase{
    struct Config {
	bool useDstGraphicBuffer;
    };

    HWColorConverter(OMX_COLOR_FORMATTYPE from, OMX_COLOR_FORMATTYPE to, const Config&);
    ~HWColorConverter();
...
private:
    ...
    bool convertFromYUV420TileTo420Planar(
