...
typedef struct x264_param_t
{
    ...
    int         i_max_width; /* max width for jz4740_alloc_frame */
    int         i_max_height; /* max height for jz4740_alloc_frame */
    int         need_sps_init; /* if reconfiguration, need to init sps */         
    struct
    {
