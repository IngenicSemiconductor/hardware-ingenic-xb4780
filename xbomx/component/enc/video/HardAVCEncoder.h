...
private:
    ...
    Vector<InputBufferInfo> mInputBufferInfoVec;
       ...
       OMX_BOOL mDynamicEvent;
       OMX_VIDEO_CONFIG_DYNAMIC_RES_SETTING *mStoredConfigDynamicResSetting;
       bool mDynamicEventChanged;
       int32_t  mVideoMaxWidth;
       int32_t  mVideoMaxHeight;
